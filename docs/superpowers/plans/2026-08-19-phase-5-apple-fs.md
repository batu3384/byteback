# Phase 5 â€” Apple FS Depth

## Delivered

- [x] HFS+ extent overflow btree â€” merges 9+ fork extents via `extentsFile`
- [x] HFS+ volume header fork offsets corrected (catalog @272, extents @192)
- [x] APFS container walk â€” NXSB parse + APSB volume enumeration (`apfs_container`, `apfs_volume`)
...
Phase 6 (Ops) â€” see `2026-08-19-phase-6-ops.md`.
