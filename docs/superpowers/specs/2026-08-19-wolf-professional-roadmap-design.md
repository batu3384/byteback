# Wolf Recovery — Professional Roadmap Design

**Date:** 2026-08-19  
**Status:** Approved (depth-first Windows forensic)  
**Scope:** wolf-recovery native engine + Electron UI

## Goal

Bring Wolf Recovery from a capable prototype to a professional forensic recovery tool competitive with X-Ways / R-Studio on Windows-first workflows, without speculative features.
