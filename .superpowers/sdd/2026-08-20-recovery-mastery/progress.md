...
- Task 4.1: complete (preview_reader 64KB, NAPI readFilePreview, IPC preload/handlers, ResultsView preview panel, preview-utils + vitest)
- Task 4.2: complete (validation.cpp post-recover carve score, RecoveryResult.validationScore, UI Quality column + report Valid/Corrupt)
