# Wolf Recovery — Tarama & Kurtarma Ustalığı Planı

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Wolf Recovery'yi ticari veri kurtarma yazılımlarına (R-Studio, Recuva, Disk Drill, PhotoRec) yaklaştırmak; ana odak disk tarama, silinmiş veri bulma genişliği ve kurtarma yetkinliği.
...
| Alan | Wolf bugün | R-Studio / PhotoRec / Recuva |
|------|-----------|------------------------------|
